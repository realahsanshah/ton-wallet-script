...
var tonweb = new TonWeb(new TonWeb.HttpProvider('https://rpc-testnet.tonsquare.io'));
function getTransactions(walletAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var addressData, address, transactions, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    addressData = ton_1.Address.parse(walletAddress);
                    debugger;
                    address = new TonWeb.utils.Address(walletAddress);
                    debugger;
                    return [4 /*yield*/, tonweb.provider.getTransactions(walletAddress)];
                case 1:
...
var walletAddress = "EQAeCIcNxWGLUSjU7gyUZkR6RExnDQknpggyUbDvGHDMBUET";
